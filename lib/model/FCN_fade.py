...
"""
    This program define the FCN-8 which is written purely by tensorflow
    Since it cannot converge as the annotation in my experiment,
    I drop to use this code but remain as a great reference.

    You should use FCN.py to train the original model
"""
